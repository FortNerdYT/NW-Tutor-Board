    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Tutor Board</h1>
          <p className="text-gray-600">Connect teachers with students for help</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                Use your @nw.sparcc.org email to access the platform
              </p>
            </div>
            ...
            <div className="text-center">
              <p className="text-xs text-gray-400">
                Only @nw.sparcc.org emails are allowed
              </p>
            </div>
          </div>
        </div>
